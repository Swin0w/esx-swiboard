...
function UpdatePlayerTable(connectedPlayers)
	...
	local ems, police, carabinieri, taxi, mechanic, cardealer, estate, players = 0, 0, 0, 0, 0, 0, 0, 0
	...
	SendNUIMessage({
		...
		jobs   = {ems = ems, police = police, carabinieri = carabinieri, taxi = taxi, mechanic = mechanic, cardealer = cardealer, estate = estate, player_count = players}
	})
